  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        danger: "bg-gradient-danger text-danger-foreground hover:opacity-90 shadow-card",
        warning: "bg-gradient-warning text-warning-foreground hover:opacity-90 shadow-card",
        success: "bg-gradient-success text-success-foreground hover:opacity-90 shadow-card",
        report: "bg-danger text-danger-foreground hover:bg-danger/90 border border-danger/20",
        search: "bg-gradient-primary text-primary-foreground hover:opacity-90 shadow-elevated",
      },
      size: {
        ...
        icon: "h-10 w-10",
        tag: "h-7 px-3 text-xs rounded-full",
      },
    },
    defaultVariants: {
      variant: "default",
